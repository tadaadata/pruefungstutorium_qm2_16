...
Test          | Sig.-Niveau 
--------------|-------------
Shapiro-Wilk  | `r pval_string(shapiro.test(as.numeric(student$Trinkverhalten))$p.value)`
Levene        | `r pval_string(leveneTest(as.numeric(student$Trinkverhalten) ~ student$Ernährungstyp)$Pr[1]`)  
